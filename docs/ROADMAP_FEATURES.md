...
*Last updated: 2026-03-27  |  Items within each phase are in priority order. Do not skip ahead.*
...
*Last updated: 2026-03-28 — Session 12 (UI): Full CFB IQ site shell complete. Navy CSS injection, branded top nav, stats bar, graph front and center. F4c marked DONE. Session 12 (docs): Coaching Semantic Model doc added, F1/F2/F4 as semantic query layer, A1 semantic data contracts, F3 review thresholds.*
